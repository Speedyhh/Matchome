import { TimSidebarListData, TimSidebarOtherData } from "@/data";
    ...
    <div className="service_details_right">
      ...
      <div className="service_details_sv_cnt text-center service_cool_head">
        <ul className="nav nav-tabs">
          {TimSidebarListData.map(({ icon, title }, index) => (
      ...
      <div className="tab-content">
        {TimSidebarListData.map(({ list }, index) => {
          return index === active ? (
      ...
      <div className="service_details_sv_cnt text-center service_class_remove mb-30">
        <ul className="nav nav-tabs">
          {TimSidebarOtherData.map(({ icon, title }, index) => (
            <li
      ...
      <div className="tab-content">
        {TimSidebarOtherData.map(({ content }, index) => {
